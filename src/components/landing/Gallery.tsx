  ...
  return (
    <section id="gallery" className="relative py-24 bg-[#1a1a1a]">
      ...
      <div className="relative z-10 container mx-auto px-4">
          ...
          {images.map((image, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#1a1a1a] via-transparent to-transparent flex items-end p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <p className="font-['Cormorant_Garamond'] font-bold text-2xl text-white">
                  {image.caption}
                </p>
              </div>
              ...
              {/* Click indicator */}
              <div className="absolute top-4 right-4 w-8 h-8 bg-[#d4af37]/20 backdrop-blur-sm rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        ...
        >
          <p className="font-['Montserrat'] text-[#f5f1e8] mb-6">
            Click any image to view full size • Follow us on social media for more updates
          </p>
          <div className="flex gap-6 justify-center">
            <motion.a
              ...
              className="text-[#d4af37] hover:text-white transition-colors duration-300 relative group"
        ...
        {selectedImage !== null && (
          <>
            ...
            >
              <motion.button
                onClick={closeLightbox}
                className="absolute top-4 right-4 z-[101] w-12 h-12 bg-[#1a1a1a] border-2 border-[#d4af37]/30 text-[#d4af37] rounded-full flex items-center justify-center hover:bg-[#d4af37] hover:text-[#1a1a1a] transition-all duration-300"
              ...
              <motion.button
                ...
                className="absolute left-4 z-[101] w-12 h-12 bg-[#1a1a1a] border-2 border-[#d4af37]/30 text-[#d4af37] rounded-full flex items-center justify-center hover:bg-[#d4af37] hover:text-[#1a1a1a] transition-all duration-300"
              ...
              <motion.button
                ...
                className="absolute right-4 z-[101] w-12 h-12 bg-[#1a1a1a] border-2 border-[#d4af37]/30 text-[#d4af37] rounded-full flex items-center justify-center hover:bg-[#d4af37] hover:text-[#1a1a1a] transition-all duration-300"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
              >
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 rounded-b-lg">
                  <p className="font-['Cormorant_Garamond'] font-bold text-2xl text-white text-center">
                    {images[selectedImage].caption}
                  </p>
                </div>
              </motion.div>

              <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-[#d4af37] text-sm font-['Montserrat'] font-medium">
